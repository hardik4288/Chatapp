...
public class ProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProfileStatus =  findViewById(R.id.status_profile_name);
        mProfileFriendsCount =  findViewById(R.id.friends_list);
        mProfileSendReqBtn =  findViewById(R.id.send_friend_request);
        mDeclineBtn =  findViewById(R.id.accept_friend_request);
